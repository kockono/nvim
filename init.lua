  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        defaults = {
          -- Layout horizontal: resultados a la izquierda, preview a la derecha
          ...
          layout_config = {
            horizontal = {
              ...
              width = 0.95,
              height = 0.85,
              -- 60% para resultados, 40% para preview
              preview_width = 0.4,
              results_width = 0.6,
            },
          },
          -- Muestra la ruta completa del archivo en los resultados
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- JSON (útil para package.json, tsconfig.json, etc.)
        jsonls = {},
